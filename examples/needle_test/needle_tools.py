...
class LLMNeedleHaystackTester:
    ...
    def run_test(self):
        ...
        print(f"correction_layer: {self.config.correction_layer}; top_k: {self.config.top_k}; correctness rate: :", correct_cnt/total_cnt)
    ...
    def start_test(self):
        ...
        self.run_test() # harder
        # print(f"correction_layer: {self.config.correction_layer}; top_k: {self.config.top_k}; correctness rate: {self.quest_needle()}")
